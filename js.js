window.onload = function() {
    ...
    //EVENT
    document.getElementById('linkIndex').addEventListener('click', function(e) {
        $('#controllerAction').val("index");
        $('#formNav').submit();
    });

    document.getElementById('linkPanier').addEventListener('click', function(e) {
        $('#controllerAction').val("panier");
        $('#formNav').submit();
    });

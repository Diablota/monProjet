...
window.onload = function() {
    ...
    // verification des erreurs à l'inscription
    document.getElementById('linkInscription').addEventListener('click', function(e) {
        ...
        hasError = setInput('adresseFacturation', 'errorAdressFact', hasError, 1);
        hasError = setInput('CodePostalFacturation', 'errorCPFact', hasError, 4);
        hasError = setInput('villeFacturation', 'errorVilleFact', hasError, 2);
        hasError = setInput('adresseLivraison', 'errorAdresseLiv', hasError, 1);
        hasError = setInput('codePostalLivraison', 'errorCPLiv', hasError, 4);
        hasError = setInput('villeLivraison', 'errorVilleLiv', hasError, 2);
    ...
    if ( document.getElementById("btnCompte") !== null ) {
